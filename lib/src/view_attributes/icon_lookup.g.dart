...
/// Lookup table for [IconData] values by [String] type key.
///
/// Maps string identifiers (names of [Icons] static members) to [IconData].
/// Keys: icon name (e.g. "add", "search") and "Icons.name" form.
/// Generated by tool/generate_icon_lookup.dart — do not edit by hand.
const _iconDataStringLookupTable = <String, IconData>{
  "abc": Icons.abc,
